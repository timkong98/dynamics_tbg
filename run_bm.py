...
pos_x, pos_y, pos_z = bm_model.position_mapping(l_x=l_trunc, l_y=l_trunc)
...
V1 = bm_model.map_wavepacket_func(f1, pos_x, pos_y)
...
V2 = bm_model.map_wavepacket_func(f2, pos_x, pos_y)
...
V3 = bm_model.map_wavepacket_func(f3, pos_x, pos_y)
...
V4 = bm_model.map_wavepacket_func(f4, pos_x, pos_y)
